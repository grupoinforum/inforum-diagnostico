...
// ---- Configuración del cuestionario (preguntas y opciones con score 1 ó 2)
// Nota: Ajustado a 7 preguntas. El resultado se determina contando cuántas respuestas tienen score === 1.
const QUESTIONS = [
  {
    id: "industria",
    ...
    try {
      const res = await fetch("/api/submit", {
        ...
        body: JSON.stringify({
          ...
          contact: form,
          utms,
          // Si más adelante agregas reCAPTCHA v3, envía el token aquí como recaptchaToken
        }),
      });
